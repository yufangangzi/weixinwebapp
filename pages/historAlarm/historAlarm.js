  ...
  getRelist(params = {}) {
    ...
    for (let index = 0; index <res.result.length; index += 1) {     
      ...
      for (let j=0;j<item.length;j++){
        ...
        this.data.codeArr.push(codeArrs);
      }
    ...
    this.setData({
      ...
      // 设备编号取值
      'items[4].children[3].children': res.result.map((n) => Object.assign({}, n, {
        label: this.data.codeArr.join(","),
        value: n.id.toString(),
      })),
    ...
    // debugger
    // this.data.items[4].children[2] = [{
    //   label: '2111-P230A/B/C',
    //   value: 'javascript',
    // },
    // {
    //   label: '2111-P230A/B/C',
